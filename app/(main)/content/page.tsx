...
import TypeTrigger from "@/app/components/TypeTrigger";
import TypeRacer from "@/app/components/TypeRacer";
import EasterEggCard from "@/app/components/EasterEggCard";
import LeaderQuoteEgg from "@/app/components/LeaderQuoteEgg";
import BiteSizedEgg from "@/app/components/BiteSizedEgg";
      ...
      <section className="py-20 bg-[#F8F5FC]">
        <div className="max-w-[1408px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-[1.06]">
