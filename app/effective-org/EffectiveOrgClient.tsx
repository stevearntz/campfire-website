      ...
      <section id="top" className="relative bg-[#1C1334] overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 pt-28 md:pt-36 lg:pt-44 pb-20 md:pb-28 text-center">
          ...
          <p className="text-lg md:text-xl text-white/60 max-w-2xl mx-auto mb-10 leading-relaxed">
            Campfire helps companies, departments, and teams increase clarity, align strategically, and reduce coordination costs — so you can execute on your strategic objectives without the drift, rework, and friction that slow most organizations down.
          </p>
