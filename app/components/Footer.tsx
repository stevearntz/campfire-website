        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="https://blog.getcampfire.com" target="_blank" className="hover:text-white transition-colors">Blog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <Link
              href="/contact"
              className="inline-block px-5 py-2.5 text-sm font-semibold text-white bg-[#6E3FCC] rounded-lg hover:bg-[#5B34AB] transition-colors"
            >
              Book a Call
            </Link>
          </div>
