          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {[
                ...
                "Leaders handle hard conversations with confidence",
                "Burnout risk is addressed earlier",
                "Change becomes more navigable",
                "Culture becomes something people experience",
              ].map((outcome) => (
                <div
                  key={outcome}
